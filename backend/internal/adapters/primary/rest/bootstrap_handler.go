...
func (h *BootstrapHandler) GetDefaults(w http.ResponseWriter, r *http.Request) {
	...
	resp := BootstrapDefaultsResponse{
		General: map[string]interface{}{
			...
			"admin_email":        envOr("IF_SYSTEM_ADMIN_EMAIL", "admin@imagefactory.local"),
			"support_email":      envOr("IF_SYSTEM_SUPPORT_EMAIL", "support@imagefactory.local"),
		...
		SMTP: map[string]interface{}{
			...
			"from":      envOr("IF_SMTP_FROM_EMAIL", "noreply@imagefactory.local"),
