...
func registerIdentitySystemAdminRoutes(
	...
	router.Get("/api/v1/admin/settings/product-info-metadata", authMiddleware.RequirePermission(permissionService, "system", "read")(http.HandlerFunc(systemConfigHandler.GetProductInfoMetadata)).ServeHTTP)
	...
	if sreSmartBotHandler != nil {
		...
		router.Get("/api/v1/admin/sre/remediation-packs", authMiddleware.RequirePermission(permissionService, "system", "read")(http.HandlerFunc(sreSmartBotHandler.ListRemediationPacks)).ServeHTTP)
		...
		router.Get("/api/v1/admin/sre/incidents/{id}/remediation-packs", authMiddleware.RequirePermission(permissionService, "system", "read")(http.HandlerFunc(sreSmartBotHandler.ListIncidentRemediationPacks)).ServeHTTP)
		router.Get("/api/v1/admin/sre/incidents/{id}/remediation-packs/runs", authMiddleware.RequirePermission(permissionService, "system", "read")(http.HandlerFunc(sreSmartBotHandler.ListIncidentRemediationPackRuns)).ServeHTTP)
		router.Post("/api/v1/admin/sre/incidents/{id}/remediation-packs/{packKey}/dry-run", authMiddleware.RequirePermission(permissionService, "system", "write")(http.HandlerFunc(sreSmartBotHandler.DryRunIncidentRemediationPack)).ServeHTTP)
		router.Post("/api/v1/admin/sre/incidents/{id}/remediation-packs/{packKey}/execute", authMiddleware.RequirePermission(permissionService, "system", "write")(http.HandlerFunc(sreSmartBotHandler.ExecuteIncidentRemediationPack)).ServeHTTP)
